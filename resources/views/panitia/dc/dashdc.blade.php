                                ...
                                <tr
                                    ...
                                    {{-- <td class="px-4 py-3">
                                        <button onclick ="previewIdentitas('baris{{$loop->iteration}}', '{{$data->id_dc}}')" data-modal-target="imageModal"
                                            ...
                                            <img class="w-20 h-20 rounded" src="{{ asset('storage/'.$data->foto) }}" alt="Large avatar" id='foto' loading="lazy">
                                        </button>                                    
                                    </td> --}}
                                    <td class="px-4 py-3">
                                    ...
                                    @else
                                        <td class="px-4 py-3"><a href="{{url('/project/downloadProjectDC/')}}/{{$data->project->file_project}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" target = "__blank">{{$data->project->file_project}}</a></td>
                                    @endif
                                ...
                                <tr>
                                    <td colspan="7">
                                        <div class="flex flex-col items-center justify-center gap-8 py-12">
                                            ...
                                            <span class="text-gray-500 tracking-wide">Data peserta <span class="text-primary-blue font-semibold">DC</span> tidak ada</span>
                                        </div>
                                    </td>
                                </tr>
                            @endif
...
<div id="updateProductModal" tabindex="-1" aria-hidden="true"   
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="{{url('/dc-update')}}" method ="POST" id="Form">
                @csrf
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/dc-delete')}}" method ="POST" id="Form">
            @csrf

        ...
        <div class="mx-auto">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <form action="/daftar-ctf/{{ $data_peserta->id_peserta }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Nama Anggota 1</label>
                        <label for="username" class="block text-sm font-light leading-6 text-gray-900">Jika tidak ada, silahkan isi dengan "-"</label>
                        <div class="my-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-lightblue w-full">
                    ...
                    <div>
                        <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Nama Anggota 2</label>
                        <label for="username" class="block text-sm font-light leading-6 text-gray-900">Jika tidak ada, silahkan isi dengan "-"</label>
                        <div class="my-2">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-primary-lightblue w-full">

...
@php
    ...
    $peserta = Peserta::where('email', auth()->user()->email)->first();
    $nomor = $peserta->nomer_peserta;
    // menentukan lomba
    if(substr($nomor,0,1) == '1'){
        $lomba = "PNBWDC";
    }else{
        $lomba = "PNBDC";
    }
...
<div class="p-4 sm:ml-64 mt-14">
    ...
    <section class="p-3 sm:p-5 antialiased">
        <div class="mx-auto">
            <h2 class="text-base mb-6 font-semibold leading-7 text-gray-900">Validasi Transaksi</h2>
                    ...
                    <div class="mx-auto flex items-center justify-center flex-col">
                        <div class="w-full">
                            ...
                            <div class="flex justify-center">
                                <a href="https://wa.me/+6282146775407?text=Halo Kak, Saya {{auth()->user()->name}} ingin mengonfirmasi bukti transaksi saya. Saya mendaftar di lomba {{$lomba}}" target="_blank"

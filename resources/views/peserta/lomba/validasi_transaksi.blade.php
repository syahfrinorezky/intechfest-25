                    ...
                    <div class="mx-auto flex items-center justify-center flex-col">
                        <div class="w-full">
                            ...
                            <div class="flex justify-center">
                                <a href="https://wa.me/+6287726675970?text=Halo Kak, Saya {{auth()->user()->name}} ingin mengonfirmasi bukti transaksi saya. Saya mendaftar di lomba {{$lomba}}" target="_blank"

...
<div class="p-4 sm:ml-64 mt-14">
    ...
    <section class="p-3 sm:p-5 antialiased">
        <div class="mx-auto">
            <h2 class="text-base font-semibold leading-7 text-gray-900">Pengumpulan Project <span class="text-primary-blue font-bold">Design Challenge</span></h2>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="-mt-1 xl:col-span-2">
                    ...
                    <form method="POST" action="/form-project-dc/{{$peserta->id_peserta}}" id="upload_form"
                        ...
                        <div class="mt-1 mb-3 text-sm text-gray-500 dark:text-gray-300" id="user_avatar_help">Karya yang diupload harus dalam format <b>rar atau zip</b> <br>dan maksimal ukuran file adalah <b>100 Mega Byte (MB)</b></div>
                        <!-- Tambahkan elemen input lainnya -->
                        <button type="submit"
                            class="mb-5 text-white bg-primary-lightblue hover:bg-primary-blue transition-all ease-in-out font-semibold focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kirim</button>
                        @if (!empty($projectSebelumnya->file_project))
                        <a href="/download-project-dc/{{$projectSebelumnya->file_project}}"
                            class="text-white mb-2 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Download
                            Project</a>
                        @endif
                    </form>

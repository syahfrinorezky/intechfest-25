...
<div class="p-4 sm:ml-64 mt-14">
    ...
    <section class="p-3 sm:p-5 antialiased">
        <div class="mx-auto">
            <h2 class="text-base font-semibold leading-7 text-gray-900">Transaksi <span class="text-primary-blue font-bold">Web Design Competition</span></h2>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="-mt-1 xl:col-span-2">
                    ...
                    <form method="POST" action="/transaksi-wdc/{{$peserta->id_peserta}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

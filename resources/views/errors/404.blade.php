    ...
    <section class="h-screen flex justify-center items-center">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">                 
                <h1 class="mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-primary-blue">404</h1>
                <p class="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl dark:text-white">Halaman tidak ditemukan.</p>
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Maaf kami tidak bisa menemukan halaman tersebut</p>
            </div>   
        </div>
    </section>

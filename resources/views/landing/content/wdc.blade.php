...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        <article class="flex flex-col shadow my-4">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                ...
                <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">Politeknik Negeri Bali <span class="text-primary-lightblue">Web Design Competition</span></a>
                <h1 class="text-2xl font-bold pb-3 mt-4">Deskripsi Lomba</h1>
                <p class="pb-3 text-justify">Politeknik Negeri Bali Web Design Competition (PNBWDC) merupakan salah satu cabang lomba dalam rangkaian kegiatan Information and Technology Festival (IntechFest) 2025. Perlombaan ini berfokus pada kemampuan merancang dan mengembangkan antarmuka web (Front-End) dengan tema utama yaitu "Edukasi Finansial". Kegiatan ini terbuka untuk masyarakat umum berusia 15 hingga 25 tahun dari seluruh Indonesia. Melalui kompetisi ini, diharapkan dapat tumbuh generasi muda yang berkompeten dan berperan aktif dalam dunia teknologi informasi, khususnya dalam pengembangan desain web, sebagai bagian dari peningkatan keterampilan dan kualitas tenaga terampil di bidang digital.
                </p>
                ...
                <ol class="items-center sm:flex">
                    <li class="relative mb-6 sm:mb-0">
                        ...
                        <div class="mt-3 sm:pr-8">
                            ...
                            <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Tanggal 13 Juli 2025</time>
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pendaftaran lomba PNBWDC dilakukan pada tanggal 13 Juli - 1 Agustus 2025</p>
                        </div>
                    </li>
                    <li class="relative mb-6 sm:mb-0">
                        <div class="flex items-center">
    ...
    <div class="w-full flex pt-6">
        ...
        <a href="{{url('/detail-ctf')}}" class="w-1/2 bg-white shadow hover:shadow-md text-right p-6">
            ...
            <p class="pt-2">Politeknik Negeri Bali Capture The Flag</p>
        </a>
    </div>
</div>

...
<div class="container mx-auto flex flex-wrap py-6">
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        <article class="flex flex-col shadow my-4">
            <!-- Article Image -->
            <div>
                <img src="{{asset('images/lomba/ilus wdc.png')}}" class="w-full md:w-2/3 lg:w-1/2 mx-auto">
            </div>
            <div class="bg-white flex flex-col justify-start p-6">
                ...
                <p class="pb-3 text-justify">Politeknik Negeri Bali Web Design Competition (PNBWDC) merupakan salah satu sub event perlombaan dalam kegiatan “Information and Technology Festival (IntechFest) 2024”. Perlombaan ini berfokus pada pengembangan desain web (Front-End) seputar destinasi wisata Indonesia. Kegiatan ini ditujukan untuk khalayak umum dengan ketentuan umur mulai dari 16 sampai 23 tahun se-indonesia. Melalui kegiatan ini, diharapkan dapat meningkatkan kualitas dan membangun peran generasi muda yang terjun dalam bidang IT khususnya desain web dalam upaya peningkatan kualitas tenaga terampil melalui peningkatan keahlian dalam bidang desain web.
                </p>

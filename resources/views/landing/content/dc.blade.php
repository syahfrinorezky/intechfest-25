    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        <article class="flex flex-col shadow my-4">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                ...
                <p class="pb-3 text-justify">Politeknik Negeri Bali Design Challenge (PNBDC) merupakan salah satu cabang lomba dalam rangkaian acara Information and Technology Festival (IntechFest) 2025. Perlombaan ini berfokus pada perancangan antarmuka serta pengalaman pengguna untuk aplikasi mobile yang bertemakan "Edukasi Finansial". Tujuan dari lomba ini adalah menghasilkan desain aplikasi yang menarik secara visual, informatif, fungsional, mudah diakses, serta mampu memenuhi kebutuhan pengguna. Kegiatan ini terbuka bagi masyarakat umum dengan rentang usia 15 hingga 25 tahun dari seluruh Indonesia. Melalui kegiatan ini, diharapkan peserta dapat meningkatkan kemampuan dan kualitas keterampilan dalam bidang UI/UX design.
                </p>
                ...
                <ol class="items-center sm:flex">
                    <li class="relative mb-6 sm:mb-0">
                        ...
                        <div class="mt-3 sm:pr-8">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">Pendaftaran lomba PNBDC dilakukan pada tanggal 13 Juli - 1 Agustus 2025</p>
                        </div>
                    </li>
                    <li class="relative mb-6 sm:mb-0">
                        <div class="flex items-center">

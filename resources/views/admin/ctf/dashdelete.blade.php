                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <button onclick="restore('baris{{$loop->iteration}}', '{{$data->id_ctf}}')" type="button" data-modal-target="deleteModal"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/data-ctf/restore')}}" method ="POST">
            @csrf
            <input type="hidden" id="restore-id_ctf" name="id_ctf">
...
<script>
    function restore(baris, id){
        ...
        document.getElementById('restore-id_ctf').value = id;
    }

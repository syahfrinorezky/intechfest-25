                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="actionsDropdown"
                                ...
                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="{{url('/project/downloadAllProjectDC')}}"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td class="px-4 py-3"><a href="{{url('/project-admin/downloadProjectDC/')}}/{{$data->file_project}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" target = "__blank">Download</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

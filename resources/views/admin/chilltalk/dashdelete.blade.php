...
@section('title', 'Data Peserta Yang Terhapus Chill Talk')

{{-- membuat content disini --}}
@section('content')
<!-- start content -->
<div class="p-4 sm:ml-64 bg-gray-50 mt-14">
<h1>Daftar Data Chilltalk Yang Terhapus</h1>
    <!-- Start block -->
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <div id="actionsDropdown"
                                ...
                                <div class="py-1">
                                    <a href="{{url('/chilltalk-admin/export_excel')}}"
                            ...
                            <tr
                                ...
                                <td class="px-4 py-3">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <button onclick="restore('baris{{$loop->iteration}}', '{{$data->id_ct}}')" type="button" data-modal-target="deleteModal"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/data-chilltalks/restore')}}" method ="POST">
            @csrf
            <input type="hidden" id="restore-id_ct" name="id_ct">
...
<script>
    function restore(baris, id){
        ...
        document.getElementById('restore-id_ct').value = id;
    }

...
@section('title', 'Data Panitia Terhapus')

{{-- membuat content disini --}}
@section('content')
<!-- start content -->
<div class="p-4 sm:ml-64 bg-gray-50 mt-14">
<h1>Data Panitia Terhapus</h1>
    <!-- Start block -->
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <button onclick="restore('baris{{$loop->iteration}}', '{{$data->id_panitia}}')" type="button" data-modal-target="deleteModal"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/data-panitia/restore')}}" method ="POST">
            @csrf
            <input type="hidden" id="restore-id_panitia" name="id_panitia">
...
<script>
    function restore(baris, id){
        ...
        document.getElementById('restore-id_panitia').value = id;
    }
</script>
@endsection
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td class="px-4 py-3">{{$data->email_panitia}}</td>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <button onclick="edit('baris{{$loop->iteration}}', '{{$data->id_panitia}}')" type="button" data-modal-target="updateProductModal"
                                            ...
                                            <li>
                                                <button onclick="hapus('baris{{$loop->iteration}}', '{{$data->id_panitia}}')" type="button" data-modal-target="deleteModal"
...
<div id="updateProductModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form action="{{url('/update-panitia')}}" method ="POST">
            @csrf
            <input type="hidden" id="edit-id_panitia" name="id_panitia">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="email_panitia" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email
                            Panitia</label>
                        <input type="text" name="email_panitia" id="edit-email_panitia"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/delete-panitia')}}" method ="POST">
            @csrf
            <input type="hidden" id="hapus-id_panitia" name="id_panitia">
...
<script>
    function edit(baris, id) {
        ...
        document.getElementById('edit-email_panitia').value = td[0].innerText
        document.getElementById('edit-nama_lengkap').value = td[1].innerText
        document.getElementById('edit-foto').value = td[2].innerText

        document.getElementById('edit-id_panitia').value = id;
    }
    function hapus(baris, id){
        const td = document.querySelectorAll('#' + baris + ' td');

        document.getElementById('hapus-id_panitia').value = id;
    }
</script>
@endsection
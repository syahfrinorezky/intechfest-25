        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <i class="fa-regular fa-address-card text-black text-xl"></i>
                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Data Pengguna</span>
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Pengumpulan Project</span>
                    <svg sidebar-toggle-item class="w-6 h-6 text-black" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"> 
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                ...
                <ul id="dropdown-project" class="py-2 space-y-2 hidden">
                    <li>
                        <a href="{{url('/project-dc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">DC</a>
                    </li>
                    <li>
                        <a href="{{url('/project-wdc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">WDC</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-transaksi" class="py-2 space-y-2 hidden">
                    <li>
                        <a href="{{url('/transaksi-dc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">DC</a>
                    </li>
                    <li>
                        <a href="{{url('/transaksi-wdc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">WDC</a>
                    </li>
                    <li>
                        <a href="{{url('/transaksi-ctf')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">CTF</a>
                    </li>
                    <li>
                        <a href="{{url('/transaksi-ct')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">CT</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-deleted" class="py-2 space-y-2 hidden">
                    <li>
                        <a href="{{url('/deleted-data-peserta')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Data Peserta</a>
                    </li>
                    <li>
                        <a href="{{url('/deleted-data-panitia')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Data Panitia</a>
                    </li>
                    <li>
                        <a href="{{url('/deleted-data-wdc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">WDC</a>
                    </li>
                    <li>
                        <a href="{{url('/deleted-data-dc')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">DC</a>
                    </li>
                    <li>
                        <a href="{{url('/deleted-data-ctf')}}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">CTF</a>
                    </li>
                    <li>
                        <a href="{{url('/deleted-data-chilltalks')}}"
                    ...
                    <li>
                        <a href="{{url('/deleted-data-transaksi-wdc')}}"
                    ...
                    <li>
                        <a href="{{url('/deleted-data-transaksi-dc')}}"
                    ...
                    <li>
                        <a href="{{url('/deleted-data-transaksi-ctf')}}"
                    ...
                    <li>
                        <a href="{{url('/deleted-data-transaksi-ct')}}"

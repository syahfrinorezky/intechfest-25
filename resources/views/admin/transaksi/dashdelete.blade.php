...
@section('title', 'Data Transaksi Terhapus')

{{-- membuat content disini --}}
@section('content')
<!-- start content -->
<div class="p-4 sm:ml-64 bg-gray-50 mt-14">
  <h1>Data Transaksi Terhapus</h1>
    <!-- Start block -->
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">DI VERIFIKASI OLEH</th>
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div id="apple-imac-27-dropdown"
                                        ...
                                        <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <button onclick ="restore('baris{{$loop->iteration}}', '{{$data->id_transaksi}}')" type="button" data-modal-target="deleteModal"
...
<div id="deleteModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form action="{{url('/data-transaksi/restore')}}" method ="POST">
            @csrf
            <input type="hidden" id="restore-id_transaksi" name="id_transaksi">
...
<script>
    function restore(baris, id){
        ...
        document.getElementById('restore-id_transaksi').value = id;
    }

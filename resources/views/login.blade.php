...
<head>
    ...
    <title>Sign In | IntechFest 2025</title>
...
<body style="font-Montserrat">
    ...
    {{-- Animation Loading --}}
    <div class="fixed inset-0 bg-gray-600 bg-opacity-55 items-center justify-center z-50 hidden" id="overlay">
    ...
    <section class="dark:bg-gray-900 relative overflow-y-hidden overflow-x-hidden h-screen">
        ...
        {{-- Kotak abstrak di kanan --}}
        <img src="{{asset('images/abstract/Square.png')}}" alt="abstract image" class="animate__animated animate__fadeInUp absolute right-80 top-40 hidden xl:block w-4" loading="lazy">
        <img src="{{asset('images/abstract/Square.png')}}" alt="abstract image" class="animate__animated animate__fadeInUp absolute right-36 top-96 hidden xl:block w-2.5" loading="lazy">
        <img src="{{asset('images/abstract/Square.png')}}" alt="abstract image" class="animate__animated animate__fadeInUp absolute right-52 bottom-44 hidden lg:block w-1.5" loading="lazy">

        <div class="flex items-center justify-center px-6 py-8 mx-auto lg:h-screen h-screen">
            {{-- ivy --}}
            <div class="hidden lg:mt-0 lg:col-span-4 lg:flex w-96 h-96 lg:ml-48 animate__animated animate__fadeInUp animate__delay-1s animate__fast">
                ...
                <video autoplay loop muted class="scale-[1.2]">
                    <source src="{{asset('images/maskot/Ivy kanan.mp4')}}" type="video/mp4">
                </video>
            </div>
                            ...
                            @csrf
                                ...
                                <div class="flex justify-center">
                                    <button type="submit" name="submit"
                                        class="w-full box-border focus:border-cyan-500 focus:outline-cyan-500 focus:ring-cyan-500 text-slate-100 hover:text-white bg-primary-lightblue hover:bg-primary-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 transition-all ease-in">
                                        Sign In
                                    </button>
                                </div>
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-center">
                                    Belum punya akun?
                                    <a href="{{ url ('/register')}}"
                                        class="font-medium focus:outline-cyan-500 underline text-primary-lightblue hover:text-primary-blue dark:text-primary-500 transition-all ease-in-out cursor-pointer">
                                        Sign Up
                                    </a>
                                </p>
                        </form>
    ...
    <script>
        ...
        eyeicon.addEventListener('click', () => {
            if(password.type == "password"){
                password.type = "text";
                eyeicon.src = 'images/abstract/Show.png';
            } else {
                password.type = "password";
                eyeicon.src = 'images/abstract/Hide.png';
            }
        })
    </script>

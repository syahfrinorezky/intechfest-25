...
<head>
    ...
    <title>Sign Up | IntechFest 2024</title>
...
<body style="font-Montserrat">
    ...
    <section class="dark:bg-gray-900 relative overflow-y-hidden overflow-x-hidden h-screen">
        ...
        <img src="{{asset('images/abstract/Square.png')}}" alt="abstract image" class="animate__animated animate__fadeInUp absolute right-72 bottom-44 hidden lg:block w-1.5" loading="lazy">
        ...
        <div class="flex items-center justify-center px-6 py-8 mx-auto lg:h-screen h-screen">
                ...
                <div class="md:w-full relative z-30 bg-white rounded-lg shadow-lg shadow-gray-400 md:mt-0 sm:max-w-md xl:p-0 overflow-x-hidden w-full">
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8 transition-all duration-1000" id="form-register">
                        ...
                        <form class="space-y-4 md:space-y-6" action="{{ url ('/register')}}" method="POST">
                            ...
                            <button id="submitRegis" type="submit" class="w-full box-border focus:border-cyan-500 focus:outline-cyan-500 focus:ring-cyan-500 text-slate-100 hover:text-white bg-primary-lightblue hover:bg-primary-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 transition ease-in">Sign Up</button>
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400 text-center">
                                Sudah punya akun? <a href="{{ url ('/login')}}" class="font-medium focus:outline-cyan-500 text-primary-lightblue underline hover:text-primary-blue dark:text-primary-500 transition-all ease-in-out cursor-pointer">Sign In disini</a>
                            </p>
                        </form>
                    </div>
                </div>
            ...
            {{-- ivy --}}
            <div class="hidden lg:mt-0 lg:col-span-4 lg:flex w-96 h-96 animate__animated animate__fadeInUp animate__delay-1s animate__fast">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(event) {
                ...
                // Optional: tambahkan timeout untuk menonaktifkan overlay jika permintaan terlalu lama
                // setTimeout(function() {
